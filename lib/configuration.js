...
module.exports = function(app, localInstance) {
  _.extend(app.settings, {
    ...
    addonsDir: path.resolve(__dirname, "../installed_addons"),
    ...
    sessionTimeout: process.env['FF_SESSION_TIMEOUT'] ? parseInt(process.env['FF_SESSION_TIMEOUT']) : null,
    awsRegion: process.env['AWS_REGION'] || 'us-west-2',
    forceGlobalHttps: process.env['FF_FORCE_GLOBAL_HTTPS'] === "1",
    sandboxCacheMaxAge: parseInt(process.env.FF_SANDBOX_CACHE_MAX_AGE || (4 * 60 * 60)),
